...
window.addEventListener("load", () => {
  ...
  myGitLink.addEventListener("click", () => {
    window.open("https://github.com/algoplutus1708");
  });
  ...
  selectAlgorithm.addEventListener("change", () => {
    ...
    switch (selectedVal) {
      ...
      case "Dijkstra":
        ...
        messageBox.textContent =
          "Dijkstra is a weighted graph search algorithm that works by picking the shortest distance neighbouring node from each node.";
        messageBox.style.color = "white";
        visualizeBtn.disabled = false;
        break;
      default:
